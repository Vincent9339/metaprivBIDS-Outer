...
.. raw:: html
    ...
    <script type="text/javascript">
        ...
        var texts = [
            ...
            " The Data Intrusion Simulation (DIS) metric has to be between 0 to 1, the default is set to: 0.2. The higher the DIS the more background knowledge we assume an adversary have.",
            ...
            "<p style='margin-top: 16px;'> For example here we see that Age has a very high contribution to the risk factor. Whereas Sex and Salary-slass contribute less.",
